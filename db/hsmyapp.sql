...
drop procedure if exists hsmy_sequence;
CREATE DEFINER=`root`@`localhost` PROCEDURE `hsmy_sequence`(in id_name_new VARCHAR(50),in id_type_new char(1),in id_len_new int)
BEGIN
